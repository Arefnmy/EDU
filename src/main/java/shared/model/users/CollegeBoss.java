...
public class CollegeBoss extends EducationalAssistant{
    ...
    private CollegeBoss(){};
    public CollegeBoss(String collegeName, Time lastEnter, String username, String password, String firstName, String lastName, String email, String mobileNumber, String nationalCode, long userCode, String roomNumber, ProfessorDegree degree) {
